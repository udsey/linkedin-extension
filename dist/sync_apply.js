(() => {
  ...
  function parseJob() {
    ...
    var locationTime = document.querySelector(".job-details-jobs-unified-top-card__primary-description-container").textContent.trim().split(" \xB7 ");
    ...
    async function attachListener() {
      ...
      try {
        ...
        btn.addEventListener("click", () => {
          job.created_at = job.applied_at = (/* @__PURE__ */ new Date()).toISOString();
          postJobs([job]);
        });
      } catch (e) {
